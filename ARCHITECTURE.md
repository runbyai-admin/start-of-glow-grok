...
- **Atmosphere (round 1).** Far hills, a pine back row, a canopy grove, a dead snag, a still-water band with a flipped wisp reflection, foreground grass and ferns that sway, drifting dust, and a vignette. Motes wander a seeded path through the grove rather than a uniform scatter. The HUD is wordless: twelve dim pips along the top that warm as motes are taken.
